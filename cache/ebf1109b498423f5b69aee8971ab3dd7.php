				...
				<div class="row">
					<div class="col-md-9 col-sm-8">
						<div class="well well-sm">
							<h2 style="font-size: 16px;margin: 5px 0;"><?php  echo $this->value['BtTypeName']; ?></h2>
						</div>
						<div class="row">
							<?php  $MYSQLVODS=(array)$this->value['BtTypeJCSQL'];$BtTypeId=$this->value['BtTypeId'];$GetMb_page=$this->value['BtTypePage']; $Count=30;$MYSQLVODS=PAGE($MYSQLVODS,$GetMb_page,$Count);  foreach($MYSQLVODS['source'] as $s){  ?>
							<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-video px-2">
								<div class="well well-sm">
									<a href="<?php 	echo  $Host1.'bt_detail'.$Host2.$s['d_id'].$Host3.$BtTypeId.$Host4; ?>">
										...
										<div class="videoBox-action">
											<span>下载次数：<?php 	echo   rand(5, 10000); ?></span>
