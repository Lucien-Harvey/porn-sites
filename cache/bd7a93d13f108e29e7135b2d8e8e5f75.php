...
<html>
	<head>
		...
		<title><?php echo $this->value['WebTitle']; ?>-<?php echo $this->value['ListName']; ?>-<?php echo $this->value['Name']; ?>套图浏览</title>
			...
			<div class="content-wrap">
				<div class="content">
					...
					<article class="article-content">
						<div class="video" style="padding: 0px;">
						...
						<ul>
							...
							<li>
								<a class="thumbnail" href="<?php 	echo  $Host1.'pic_detail'.$Host2.$MYSQLVODs['a_id'].$Host3.$PicType.$Host4; ?>" style="height: auto;">
									<img src="<?php 	echo  $MYSQLVODs['a_remarks'] ?>" style="width: 100%;height: auto;max-height: 133px;" data-src="<?php 	echo  $MYSQLVODs['a_remarks'] ?>"
									 class="thumb">
