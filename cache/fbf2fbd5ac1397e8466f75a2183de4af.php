...
<title><?php echo $this->value['Name']; ?> - <?php  echo $this->value['VideoTypeName']; ?> - <?php echo $this->value['WebTitle']; ?></title>
...
　<p align=center> <font color="FC0000" size="4">正在进入播放页面，请耐心等待</font><font color="FC0000" size="3" face="Arial">...</font>
...
<ul class="panel-list">
 ...
 <?php  $VideoType=$this->value['VideoType']; $MYSQLVOD=(array)$this->value['VideoTypeJCSQL'];shuffle($MYSQLVOD);  $Count=4;for ($x=0; $x<=$Count-1; $x++) {  $MYSQLVODs=$MYSQLVOD[$x];  ?>
 <li class="video last">
<a href="<?php 	echo  $Host1.'video_detail'.$Host2.$MYSQLVODs['d_id'].$Host3.$VideoType.$Host4; ?>" target="_blank" title="<?php 	echo  $MYSQLVODs['d_name'] ?>">
<div class="thumb"><img src="<?php 	echo  $MYSQLVODs['d_pic'] ?>" alt="<?php 	echo  $MYSQLVODs['d_name'] ?>" /></div>
<h2 class="f16 video-title product-buyer-name"><?php 	echo  $MYSQLVODs['d_name'] ?></h2>
