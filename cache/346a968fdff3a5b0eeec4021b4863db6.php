			...
			<div class="content-wrap">
				<div class="content">
					...
					<article class="article-content">
						<div class="bfdz">
							...
							<a href="<?php echo $this->value['CUrl']; ?>" target="iFrame1" class="lBtn">
								<i class="fa fa-play-circle-o fa-spin fa-lg"></i> 在线播放 </a>
							<a href="<?php echo $this->value['CUrl']; ?>" target="iFrame1" class="lBtn">
								<i class="fa fa-play-circle-o fa-spin fa-lg"></i> 备用路线 </a>
						</div>
					</article>
					...
					<div class="postitems">
						...
						<hr>
						<ul>
							<?php  $VideoType=$this->value['VideoType']; $MYSQLVOD=(array)$this->value['VideoTypeJCSQL'];shuffle($MYSQLVOD);  $Count=8;for ($x=0; $x<=$Count-1; $x++) {  $MYSQLVODs=$MYSQLVOD[$x];  ?>
							<li>
								<a class="thumbnail" href="<?php 	echo  $Host1.'video_detail'.$Host2.$MYSQLVODs['d_id'].$Host3.$VideoType.$Host4; ?>" style="height: auto;">
									<img src="<?php 	echo  $MYSQLVODs['d_pic'] ?>" style="width: 100%;height: auto;max-height: 133px;" data-src="<?php 	echo  $MYSQLVODs['d_pic'] ?>" class="thumb">
			...
			<div class="sidebar">
				<div class="widget widget-postlist">
					...
					<ul>
						...
						<li>
							<a class="thumbnail" href="<?php 	echo  $Host1.'video_detail'.$Host2.$MYSQLVODs['d_id'].$Host3.$VideoType.$Host4; ?>" style="height: auto;">
								<img src="<?php 	echo  $MYSQLVODs['d_pic'] ?>" style="width: 100%;height: auto;max-height: 133px;" data-src="<?php 	echo  $MYSQLVODs['d_pic'] ?>" class="thumb" style="display: inline;">
								<i class="fa fa-camera"></i>
