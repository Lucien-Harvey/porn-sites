...
<html>
	<head>
		...
		<title><?php echo $this->value['WebTitle']; ?>-<?php echo $this->value['ListName']; ?>-<?php echo $this->value['Name']; ?>种子下载</title>
		...
		<section class="container">
				...
				<div class="content">
					...
					<article class="article-content">
						<div class="jw-aspect jw-reset playBox" align="center">
							<a href="<?php echo $this->value['Play']; ?>" style="    color: #fff;"><img src="<?php echo $this->value['StylePath']; ?>/images/btlading.jpg" style="width:100%;height:100%"></a>
						</div>
					</article>
					...
					<div class="postitems">
						...
						<hr>
						<ul>
							<?php  $BtType=$this->value['BtType']; $MYSQLVOD=(array)$this->value['BtTypeJCSQL'];shuffle($MYSQLVOD);  $Count=8;for ($x=0; $x<=$Count-1; $x++) {  $MYSQLVODs=$MYSQLVOD[$x];  ?>
							<li>
								<a class="thumbnail" href="<?php 	echo  $Host1.'bt_detail'.$Host2.$MYSQLVODs['d_id'].$Host3.$BtType.$Host4; ?>" style="height: auto;">
									<img src="<?php 	echo  $MYSQLVODs['d_pic'] ?>" style="width: 100%;height: auto;max-height: 133px;" data-src="<?php 	echo  $MYSQLVODs['d_pic'] ?>"
									 class="thumb">
									<i class="fa fa-camera"></i>
									<?php 	echo  $MYSQLVODs['d_name'] ?>
								</a>
							</li>
							<?php  } ?>
						</ul>
			...
			<div class="sidebar">
				<div class="widget widget-postlist">
					...
					<ul>
						<?php  $BtType=$this->value['BtType']; $MYSQLVOD=(array)$this->value['BtTypeJCSQL'];shuffle($MYSQLVOD);  $Count=12;for ($x=0; $x<=$Count-1; $x++) {  $MYSQLVODs=$MYSQLVOD[$x];  ?>
						<li>
							<a class="thumbnail" href="<?php 	echo  $Host1.'bt_detail'.$Host2.$MYSQLVODs['d_id'].$Host3.$BtType.$Host4; ?>" style="height: auto;">
								<img src="<?php 	echo  $MYSQLVODs['d_pic'] ?>" style="width: 100%;height: auto;max-height: 133px;" data-src="<?php 	echo  $MYSQLVODs['d_pic'] ?>"
								 class="thumb" style="display: inline;">
								<i class="fa fa-camera"></i>
								<font color="FF00DE"><?php 	echo  $MYSQLVODs['d_name'] ?></font>
							</a>
						</li>
						<?php  } ?>
					</ul>
